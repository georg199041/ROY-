...
CREATE TABLE IF NOT EXISTS `navigation_pages` (
  ...
  CONSTRAINT `navigation_pages_ibfk_4` FOREIGN KEY (`navigation_pages_id`) REFERENCES `navigation_pages` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `navigation_pages` (`id`, `navigation_pages_id`, `label`, `type`, `uri`, `action`, `controller`, `module`, `params`, `route`, `reset_params`, `encode_url`, `checked_out_by`, `checked_out_ts`, `created_by`, `created_ts`, `modified_by`, `modified_ts`) VALUES
(1, NULL, 'Administration', 'MVC', NULL, 'index', 'admin-index', 'default', NULL, NULL, 'YES', 'YES', NULL, NULL, NULL, NULL, NULL, NULL);
