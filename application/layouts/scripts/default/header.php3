<div class="front-header">
	<div class="front-header-width">
		<div class="front-header-infobox">
			...
			<a class="front-logo-text" href="/"><?php // echo $this->translate('Skeleton Application', 'ru'); ?></a>
		</div>
		<div class="front-header-menu-container">
			<div class="front-header-menu-left"></div>
			<ul class="front-header-menu-center">
				<li class="front-header-menu-center__item">
					<a href="/" class="front-header-menu-center__item-href front-header-menu-center__item-href_active"><span class="front-header-menu-center_gradient">главная</span></a>
				</li>
				<li class="front-header-menu-center__item">
					<a href="/" class="front-header-menu-center__item-href"><span class="front-header-menu-center_gradient">о клубе</span></a>
				</li>
				<li class="front-header-menu-center__item">
					<a href="/" class="front-header-menu-center__item-href"><span class="front-header-menu-center_gradient">оздоравление и реабилитация</span></a>
				</li>
				<li class="front-header-menu-center__item">
					<a href="/" class="front-header-menu-center__item-href"><span class="front-header-menu-center_gradient">база клуба</span></a>
				</li>
				<li class="front-header-menu-center__item">
					<a href="/" class="front-header-menu-center__item-href"><span class="front-header-menu-center_gradient">контакты</span></a>
				</li>
				<?php
