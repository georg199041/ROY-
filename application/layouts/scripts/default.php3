...
<!-- 				<div class="front-body-slider-color-cutter-container"><div class="front-body-slider-color-cutter"></div></div> -->
		...
		<div class="front-body-container">
			...
			<div class="front-body-container-schema">
				<div class="front-result-box-title">
					<span class="front-title-content">УНИКАЛЬНАЯ система<br/> восстановления<?php echo $this->partial('default/body.php3'); ?></span>
				</div>
				<div class="front-body-container-schema-main">
					<div class="front-body-schema-center">
